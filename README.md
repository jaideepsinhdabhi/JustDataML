...
<img src="logo.png" width="150" height="250">
...
```bash
python JDML.py --Train --Predict <test.csv> --Output <Output Name>
...
- **Normalization_tech:** Normalization technique to be applied (`StandardScaler`, `MinMaxScaler`, etc.). (only `StandardScaler` supported )
